...
HD_PWD='C:/FPGA_Harman/20250305_fsm_exam/20250305_fsm_exam.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log fsm_exam.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source fsm_exam.tcl -notrace

...
HD_PWD='C:/FPGA_Harman/20250305_fsm_exam/20250305_fsm_exam.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log fsm_exam.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source fsm_exam.tcl
